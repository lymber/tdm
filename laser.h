...
{  
 ...
 public:
  ...
  ///
  /// Faço a atualização via Objeto::Atualiza e me marco para sair da lista de objetos no caso em que tiver batido no cenário    
  ...
  /// SIM para SOLIDO. Responde SIM ou NAO para MEU_PAI, dependendo se param for igual ao pai. Se a mensagem for PAI_MORTO, então deixa o valor de pai = NULL e deixa de verificar coisas relativas a ele. Se a pergunta não é uma dessas ela repassa a pergunta para Objeto.
  ...
  /// \return Um inteiro constante que representa a resposta dela ou a resposta fornecida por Objeto.
  ...
  Laser(Central *central, Objeto *paiAux);
};

/// \brief Controla um inimigo medroso com alguma inteligência artificial
///
/// Controla objetos do tipo medroso, determinando seus movimentos e tiros. Ele foge se o jogador está "de frente" para ele, o persegue e atira em caso contrário.

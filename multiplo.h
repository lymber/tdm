...
///
/// Cada instância dessa classe é um tiro corrente. Quando criado, cria mais duas cópias em direções diagonais.

class Multiplo : public Objeto
{  
  /// \brief Se devo criar outras cópias
  ///
  /// Depois de criada as cópias, mudo para false. Cópias não criam cópias (recebem mensagem para isso)
  bool criaCopias;
 ...
 public:
  ...
  /// \brief O construtor
  ///
  /// Faz o som de que foi solo um tiro, ajeita a posição e direção para que fiquem iguais ao do pai
